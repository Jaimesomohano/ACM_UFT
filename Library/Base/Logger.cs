...
namespace APlus_UFT.Library.BaseLibrary
{
    ...
    public static class Logger
    {
        ...
        public static string GenerateLogFile(string CaseID)
        {
            ...
            if (!Directory.Exists(DirectoryBase.LogDir))
            {
                Directory.CreateDirectory(DirectoryBase.LogDir);
            }

            _logFilePath = Path.Combine(DirectoryBase.LogDir, CaseID + "-" + fileDate + _logSuffix);
